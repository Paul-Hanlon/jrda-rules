...
export const QUIZ_TOPICS_13_PLUS: QuizTopic[] = [
  // ─────────────────────────────────────────────
  // 1. Game Basics
  // ─────────────────────────────────────────────
  {
  ...
  // ─────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation:
          'A Star Pass is when the Jammer transfers their Role to their team\'s Pivot by handing the Star to the Pivot. Both Skaters must be Upright, In Bounds, In Play, and neither may be en route to or In Queue for the Penalty Box.',
        ruleReference: '2.2.4',
        skillLevels: ['L2', 'L3'],
      },
      {
  ...
  // ─────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation:
          'A Jammer can score up to four points per trip -- one for each opposing Blocker. Not-on-the-Track points count toward this total for opposing Blockers who are off the track (e.g., in the Penalty Box).',
        ruleReference: '3.1',
        skillLevels: ['L1', 'L2', 'L3'],
      },
      {
